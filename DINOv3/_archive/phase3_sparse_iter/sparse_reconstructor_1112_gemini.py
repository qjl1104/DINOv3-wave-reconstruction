...
# Replaced 'separated' Self/Cross Attention with an 'interleaved'
# architecture inspired by LightGlue/SOTA matchers.
# This allows information to flow between images at each layer,
# rather than only at the end. (See MatchingLayer and SparseMatchingNetwork).
#
...
class Trainer:
    ...
    def __init__(self, cfg: Config):
        ...
        self.run_dir = os.path.join(cfg.RUNS_BASE_DIR, self.timestamp + "_v2.8_interleaved")  # Added tag to dir
    ...
    def train(self):
        ...
        print("\n--- Starting Sparse Matching Training (v2.8: Interleaved Arch) ---")
        print(
