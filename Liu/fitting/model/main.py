...
parser.add_argument('--trainPath', type=str, default='D:\安装包\外协\某水面船测距文件\Tra/')
parser.add_argument('--valPath', type=str, default='D:\安装包\外协\某水面船测距文件\Val2/')
...
randomcrop = transforms.RandomCrop(4, 20)
train_iter, val_iter = get_data(batch_size, train_path, val_path, randomcrop, 30, ex=50, num_workers=args.num_workers)
...
optimizer_g = torch.optim.Adam(G.parameters(), lr=lr * 0.01)
