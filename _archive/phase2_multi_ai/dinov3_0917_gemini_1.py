...
# (V25 Final - Masked Disparity Visualization)
...
class Trainer:
    ...
    def visualize(self, inputs, outputs, loss_components, step, phase="train"):
        ...
        # [V25 Core Change] Apply mask to disparity map for visualization
        ...
        # [V25 Core Change] Display the masked disparity
        im2 = ax2.imshow(masked_disp, cmap='viridis')
        plt.title("Predicted Disparity Map (Masked)")
        ax2.set_facecolor('black')  # Set background to black for clarity
        plt.axis('off')
