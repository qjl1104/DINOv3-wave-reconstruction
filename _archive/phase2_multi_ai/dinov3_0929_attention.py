...
# FINAL STABLE ARCHITECTURE: RAFT-style iterative refinement with ConvGRU update.
# This version removes the attention mechanism which proved unstable on sparse data,
# and reverts to the robust strategy of deepening the custom CNN modules.
# This represents the most reliable configuration based on our iterative experiments.
...
class Config:
    ...
    BATCH_SIZE: int = 1
    # Optimized Learning Rate from successful experiments
