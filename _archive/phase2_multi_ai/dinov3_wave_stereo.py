...
class Config:
    ...
    MAX_DISPARITY: int = 160   # 足够安全；若 cap 长期=0，可调成 144 以提速

    # 自监督损失
    PHOTOMETRIC_LOSS_WEIGHTS: tuple = (0.7, 0.3)  # (SSIM, L1) 略增 L1 权重更稳
    ...
    AUGMENTATION_PROBABILITY: float = 0.3  # 先稳住，再逐步加大
